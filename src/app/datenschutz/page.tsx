    ...
    <section className="pt-32 pb-24 md:pb-32 md:pt-40">
      <div className="prose prose-neutral mx-auto max-w-3xl px-4 sm:px-6">
        ...
        <p className="font-semibold uppercase text-sm leading-relaxed">
          ...
          anschlie&szlig;end nicht mehr zum Zwecke der Direktwerbung verwendet
        ...
        <p>
          ...
          (nachfolgend &bdquo;Form.taxi&ldquo;). Um Ihnen die
          Funktionalit&auml;t des Formulars zur Verf&uuml;gung zu stellen,
          ...
          weitergegeben. Au&szlig;erdem werden von Form.taxi unter anderem
          ...
          gew&uuml;nschte Funktionalit&auml;t des Formulars bereitzustellen.
          Rechtsgrundlage f&uuml;r die Nutzung von Form.taxi ist Art. 6
          Abs. 1 S. 1 lit. f DS-GVO (berechtigtes Interesse). Die
          Datenverarbeitung und Speicherung erfolgt innerhalb der
          Europ&auml;ischen Union. Weitere Informationen entnehmen Sie der
          Datenschutzerkl&auml;rung von Form.taxi:{" "}
          <a
