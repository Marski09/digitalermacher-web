...
export const metadata: Metadata = {
  title: "Datenschutz \u2013 Digitalermacher",
};
  ...
  return (
    <section className="pt-32 pb-24 md:pb-32 md:pt-40">
      <div className="prose prose-neutral mx-auto max-w-3xl px-4 sm:px-6">
        <h1 className="!text-[1.91rem]">Datenschutzerklärung</h1>
        ...
        <p>
          ...
          Analyse Ihres Nutzerverhaltens verwendet werden. Sofern über
          die Website Verträge geschlossen oder angebahnt werden
          können, werden die übermittelten Daten auch für
        ...
        <p>
          ...
          und § 25 Abs. 1 TDDDG, soweit die Einwilligung die
        ...
        <p>
          ...
          Falle einer ausdrücklichen Einwilligung in die
          ...
          Datenverarbeitung zusätzlich auf Grundlage von § 25
        ...
        <p className="font-semibold uppercase text-sm leading-relaxed">
        ...
        <h4>Verwendung unseres Online-Formulars</h4>
        <p>
          Unsere Internetseite nutzt Form.taxi, einen Webdienst der Webseite{" "}
          <a href="https://form.taxi" target="_blank" rel="noopener noreferrer">
            https://form.taxi
          </a>{" "}
          (nachfolgend „Form.taxi“). Um Ihnen die
          Funktionalität des Formulars zur Verfügung zu stellen,
          senden wir die von Ihnen angegebenen Daten an Form.taxi. Diese Daten
          werden dort verarbeitet, gespeichert und an uns per E-Mail
          weitergegeben. Außerdem werden von Form.taxi unter anderem
          weitere Daten wie Ihre IP-Adresse, Ihr Typ des Browsers, die Domain
          der Webseite, das Datum und die Zeit des Zugriffs erhoben, um die
          gewünschte Funktionalität des Formulars bereitzustellen.
          Rechtsgrundlage für die Nutzung von Form.taxi ist Art. 6
          Abs. 1 S. 1 lit. f DS-GVO (berechtigtes Interesse). Die
          Datenverarbeitung und Speicherung erfolgt innerhalb der
          Europäischen Union. Weitere Informationen entnehmen Sie der
          Datenschutzerklärung von Form.taxi:{" "}
          <a
